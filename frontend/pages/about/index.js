...
var Aboutpage = Barba.BaseView.extend({
  ...
  onEnterCompleted: function() {
    ...
    tlDescriptionWch.to(description, 0.8, { opacity: 0, ease: Power1.easeOut }, 0);
    ...
    tlRatingGroupWch.staggerFrom(ratingsItems, 2.5, { autoAlpha: 0, ease: Power1.easeOut }, 0.5, 0.8);
